...
为每个意图生成 1-3 个语义检索查询。查询必须：
- **保留原始查询中的具体实体、关键词和核心检索词**（人名、法律名称、条款编号、机构名等）
- **是自包含的检索查询**，不依赖上下文即可理解
- **不要生成元指令**（如"请搜索..."、"请查找..."、"请在知识库中..."）
- **多样化**：覆盖不同的表述角度（同义词、专业术语、假设文档片段）
- **适度具体**：不要过于宽泛（如"法律"），也不要过于狭窄

正确示例：
- "中华人民共和国电影产业促进法第二十五条" ✓（保留了完整实体）
- "离婚财产分割的典型裁判案例" ✓（概念性检索查询）
- "民法典关于夫妻共同财产分割的规定" ✓（保留了法律名称）

错误示例：
- "请帮我查找电影产业促进法的相关条款" ✗（元指令）
- "法律 条款 内容" ✗（关键词堆砌，丢失了具体法律名称）
- "查找相关法条" ✗（过于宽泛，丢失了所有实体信息）
